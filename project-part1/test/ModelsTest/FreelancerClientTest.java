...
//         when(client.url("https://www.freelancer.com/api/projects/0.1/projects/active?query=python%20developers&compact=false&job_details=true")).thenReturn(request);
...
//         // when(request.addQueryParameter("compact", "1")).thenReturn(request);
...
// public class FreelancerClientTest extends Mockito{
//     WSClient client = mock(WSClient.class);
//     private AsyncCacheApi mockCache(Object cachedValue) {
...
//                 return cachedValue;
//             }
//             final Callable<?> provider1 = params.getArgument(1);
//             System.out.println("provider1");
//             // System.out.println(provider1.call()==null);
//             // System.out.println("we are here "+provider+" "+params.getArgument(1));
//             return provider1.call();
//         });
//         return cache;
    // }

    // @Mock
    // FreelancerClient freelancerMock;

    // @Before
    // public void setup(){
    //     freelancerMock = new FreelancerClient(client, mockCache(null), ConfigFactory.load());
    // }

    // @Test
    // public void testSearchProjects() throws Exception {
    //     FreelancerClient fp = freelancerMock;
    //     System.out.println("printing null");
    //     // fp.searchProjects("python developers");
    //     assertEquals("",fp.searchProjects("python developers"));
        
    // }

    // @Test
    // public void testgetOwnerProfile() throws Exception{
    //     FreelancerClient fp = freelancerMock;
    //     assertEquals("",fp.getOwnerProfile("33332847"));
    // }
// }
